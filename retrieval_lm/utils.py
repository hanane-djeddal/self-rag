...
TASK_INST = {
    ...
    "hagrid": "Answer the following question. The question may have multiple aspects, and in that case, you have to provide a long-form answer covering all aspects of the answer.",
}
